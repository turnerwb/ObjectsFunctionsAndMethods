...
#            It draws the objects that have been attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#           When you want to window to stay open until the user clicks, but are done with editing that particular window
#           if you do not include the call the code continues to run, opening the next window or progressing farther
#           into the code
#
