...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    brownie = rg.SimpleTurtle()
    brownie.pen = rg.Pen("brown", 5)
    brownie.forward(150)
    brownie.left(90)
    brownie.forward(50)
    brownie.backward(100)
    ####################################################################
...
def try_methods_and_functions():
    ...
    """
    maria = rg.SimpleTurtle()
    maria.pen = rg.Pen("blue", 5)
    maria.backward(150)
    maria.speed = 1
    draw_many_squares(maria, 2, 100, 30)
    maria.speed = 5
    maria.pen = rg.Pen("red", 5)
    draw_many_squares(maria, 10, 50, 15)
    maria.speed = 100
    maria.pen = rg.Pen("red", 35)
    draw_many_squares(maria, 8, 300, 60)
    maria.pen = rg.Pen("black", 3)
    maria.backward(200)
    maria.draw_circle(30)
    maria.draw_square(50)
    ####################################################################
